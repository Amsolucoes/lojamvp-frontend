                  ...
                  <div className="variacoes-secao" style={{ gridColumn: '1/-1' }}>
                    ...
                    {variacoes.length === 0 ? (
                      ...
                      <div className="variacoes-scroll-wrap" style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                        <div className="variacao-header-row" style={{ display: 'grid', gridTemplateColumns: `${[catUsaTamanho && '70px', catUsaCor && '90px', usarCodigoPorVariacao && '130px'].filter(Boolean).join(' ')} 60px 55px 28px`, gap: 6 }}>
                        ...
                        {variacoes.map((v, i) => (
                          <div key={i} className="variacao-row" style={{ display: 'grid', gridTemplateColumns: `${[catUsaTamanho && '70px', catUsaCor && '90px', usarCodigoPorVariacao && '130px'].filter(Boolean).join(' ')} 60px 55px 28px`, gap: 6, alignItems: 'center' }}>
                            {catUsaTamanho && (
